...
MISSION_MESSAGES = {
    ...
    "reto_improve": "Mejorar recompensa (+5 puntos)",
    "reto_avoid": "Evitar penalización (5 puntos)",
    "reto_upgraded": "¡Recompensa mejorada!",
    "reto_penalty_avoided": "Penalización evitada.",
    "reto_no_points": "No tienes puntos suficientes.",
